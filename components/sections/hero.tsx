        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-700">
              ...
              AI-powered product photography preview
            </div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-slate-600">
              Upload your product photo, pick a scene, and preview how AI can
              transform it into professional e-commerce images. Built for{" "}
