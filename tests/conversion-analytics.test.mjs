...
test("Plausible maps every conversion and splits pricing CTAs into their funnel event", () => {
  const cases = [
    ...
    [{ name: analytics.conversionEvents.seoPrimaryCtaClick, properties: { page_path: "/marketplace-image-fixer/", source_page: "/marketplace-image-fixer/", cta_id: "marketplace_export_sign_in" } }, "pricing_cta_click"],
    [{ name: analytics.conversionEvents.seoPrimaryCtaClick, properties: { page_path: "/marketplace-image-fixer/", source_page: "/marketplace-image-fixer/", cta_id: "marketplace_export_account" } }, "pricing_cta_click"],
...
test("post-export account CTA projection stays on the fixed pricing-intent contract", () => {
  const projected = analytics.plausibleEventFor({
    name: analytics.conversionEvents.seoPrimaryCtaClick,
    properties: {
      page_path: "/marketplace-image-fixer/",
      source_page: "/marketplace-image-fixer/",
      cta_id: "marketplace_export_sign_in",
      filename: "private-catalog.jpg",
      email: "seller@example.com",
    },
  });
  assert.equal(projected.name, "pricing_cta_click");
  assert.deepEqual(projected.props, {
    page_path: "/marketplace-image-fixer/",
    source_page: "/marketplace-image-fixer/",
    cta_id: "marketplace_export_sign_in",
